...
This is a \LaTeX rendering of the word files.
...
\begin{equation*}
    \sqrt{\frac{2}{\pi}} \frac{(\sin
        \theta)^\mu}{\Gamma\left(\frac{1}{2}-\mu\right)} \int_0^\theta \frac{\cosh
        (\tau t) \mathrm{d} t}{(\cos t-\cos \theta)^{\mu+1 / 2}}
\end{equation*}
